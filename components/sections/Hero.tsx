        ...
        <div className="grid items-center gap-14 pb-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-10 lg:pb-24">
          ...
          <div className="relative z-10 max-w-[660px]">
            <div className="enter mb-8" style={at(0.02)}>
              <div className="relative h-60 w-60 overflow-hidden rounded-full border-2 border-white/10 grayscale filter transition-all duration-500 hover:border-accent hover:grayscale-0 md:h-52 md:w-52">
                <Image
                  src="/profile.png"
                  alt="Ran Levi"
                  fill
